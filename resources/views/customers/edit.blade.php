...
@section('title_section')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{URL::route('customers.edit', $customer->id)}}">Editar usuario</a>
            </li>
        </ul>
    ...
    <div class="row">
        {!! Form::model($customer, array('method' => 'put', 'route' => ['customers.update', $customer->id], 'class' => 'form', 'id'=>'form_customer')) !!}
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li>
                                    <a href="{{ URL::route('customers.show', $customer->id) }}">
                                ...
                                <li class="divider"></li>
                                <li>
                                    <a href="javascript:;" onclick="$('#form_customer').submit()">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <ul class="ver-inline-menu tabbable margin-bottom-10">
                                ...
                                <li>
                                    <a href="#professionals_tab" data-toggle="tab" aria-expanded="false">
                                        <i class="fa fa-briefcase"></i> Datos profesionales </a>
                                </li>
                                <li class="non-estudiante">
                                    <a href="#categories_tab" data-toggle="tab">
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="professionals_tab">
                                    <div class="portlet light bordered">
                                        <div class="portlet-body form">
                                            <div class="form-body">
                                                <div class="md-checkbox">
                                                    {!! Form::checkbox('student', null, $customer->student == 1, array('class'=>'md-check', 'id'=>'form_student', 'onclick'=>'switchSelectsByCheck()')) !!}
...
@section('scripts_section')
    ...
    <script>
        jQuery(document).ready(function () {
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 12;})->first()))
            customers.select2Initialization(
                    '#form_country',
                    ' ',
                    12,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 12;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_country',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 1;})->first()))
            customers.select2Initialization(
                    '#form_professional_type',
                    ' ',
                    1,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 1;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_professional_type',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 3;})->first()))
            customers.select2Initialization(
                    '#form_profession',
                    ' ',
                    3,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 3;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_profession',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 2;})->first()))
            customers.select2Initialization(
                    '#form_specialty',
                    ' ',
                    2,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 2;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_specialty',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 4;})->first()))
            customers.select2Initialization(
                    '#form_position',
                    ' ',
                    4,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 4;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_position',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 5;})->first()))
            customers.select2Initialization(
                    '#form_institution',
                    ' ',
                    5,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 5;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_institution',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 6;})->first()))
            customers.select2Initialization(
                    '#form_dedication',
                    ' ',
                    6,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 6;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_dedication',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 7;})->first()))
            customers.select2Initialization(
                    '#form_teaching_category',
                    ' ',
                    7,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 7;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_teaching_category',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 9;})->first()))
            customers.select2Initialization(
                    '#form_investigative_category',
                    ' ',
                    9,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 9;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_investigative_category',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 10;})->first()))
            customers.select2Initialization(
                    '#form_scientific_category',
                    ' ',
                    10,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 10;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_scientific_category',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 8;})->first()))
            customers.select2Initialization(
                    '#form_occupational_category',
                    ' ',
                    8,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 8;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_occupational_category',
                    ...
                    false);
            @endif
            @if(!is_null($customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 11;})->first()))
            customers.select2Initialization(
                    '#form_customer_type',
                    ' ',
                    11,
                    '{{URL::route('nomenclators.json')}}',
                    '{{$customer->nomenclators->filter(function($nomenclator){return $nomenclator->nomenclator_type_id == 11;})->first()->id}}',
                    false);
            @else
            customers.select2Initialization(
                    '#form_customer_type',
